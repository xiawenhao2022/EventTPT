...
# network related
from lib.models.EventTPT import build_ostrack
from lib.models.EventTPT import build_viptrack
# forward propagation related
from lib.train.actors import ViPTActor
# for import modules
import importlib
...
def run(settings):
    settings.description = 'Training script for EventTPT'
    ...
    # Create network
    if settings.script_name == "EventTPT":
